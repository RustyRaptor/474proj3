...
baboons: baboons.o
	...
	# gcc -Werror -Wall -O3 baboons.o -o baboons
	# gcc -Werror -Wall baboons.o -o baboons
	# gcc -Wall baboons.o -o baboons
...
baboons.o: baboons.c
	# gcc -Werror -Wall -O0 -c baboons.c
	# gcc -Werror -Wall -O3 -c baboons.c
	# gcc -Werror -Wall -c baboons.c
	# gcc -Wall -c baboons.c
